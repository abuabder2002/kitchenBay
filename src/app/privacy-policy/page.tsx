...
export default function PrivacyPolicyPage() {
  const sections = [
    ...
    { icon: <Trash2 size={24} />, title: 'Your Rights', content: 'You have the right to access, update, or delete your personal information at any time. You may also opt out of marketing communications. To exercise these rights, please contact us at privacy@Kitchenbaycraft.in.' },
  ];
      ...
      <main className="flex-1">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
          <p className="text-gray-600 text-lg leading-relaxed mb-12">
            At KitchenbayCraft, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make a purchase.
          </p>
          ...
          <div className="mt-12 p-6 bg-yellow-50 border border-yellow-200 rounded-2xl">
            ...
            <p className="text-gray-600">Contact us at <a href="mailto:privacy@Kitchenbaycraft.in" className="text-blue-600 hover:underline font-medium">privacy@Kitchenbaycraft.in</a></p>
          </div>
        </div>
      </main>
      <Footer />

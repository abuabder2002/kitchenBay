      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-16">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Kitchenbay is a GST-registered business. A GST-compliant invoice is automatically generated for every order placed on our platform. You can download your invoices from the <strong>My Orders</strong> section of your account.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
              <p className="text-xs text-gray-500 mb-1">Business Name</p>
              <p className="font-semibold text-gray-900">Kitchenbay India Pvt. Ltd.</p>
            </div>
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">

      ...
      <main className="flex-1">
        ...
        <div className="bg-blue-950 text-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-blue-200 text-xl max-w-2xl mx-auto">At Kitchenbay, every role directly impacts the lives of thousands of Kitchenbay families. Come do meaningful work.</p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
          {/* Perks */}
          <div>
            <h2 className="text-2xl font-bold font-[family-name:var(--font-heading)] text-gray-900 mb-8 text-center">Why Kitchenbay?</h2>
            ...
            <div className="space-y-4">
              {openings.map((job, idx) => (
                <div key={idx} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:shadow-md transition-shadow group">
                  ...
                  <a href="mailto:careers@Kitchenbay.in" className="shrink-0 bg-[--color-brand-accent] text-white font-semibold px-5 py-2.5 rounded-full hover:bg-[--color-brand-accent-hover] transition-colors text-sm">
                    Apply Now
                  </a>
                </div>
              ))}
          ...
          <div className="text-center bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
            ...
            <a href="mailto:careers@Kitchenbay.in" className="inline-block bg-blue-950 text-white font-semibold px-6 py-3 rounded-full hover:bg-blue-900 transition-colors">

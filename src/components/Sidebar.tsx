      ...
      <div className="flex items-center justify-between p-4 border-b border-blue-900/60">
        {!collapsed && (
          <div className="flex items-center gap-2">
            <Image src={logoImg} alt="ShopNest Logo" width={120} height={40} className="object-contain h-8 w-auto rounded-md invert brightness-0" />
          </div>
        )}
        <button
          ...
          <div className="mt-3 mx-1 p-3 bg-blue-950/50 rounded-xl border border-blue-800/40">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-blue-300/60 text-xs">admin@shopnest.in</p>
              </div>
            </div>
          </div>
        )}

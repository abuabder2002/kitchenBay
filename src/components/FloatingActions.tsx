...
function ScrollToTopButton() {
  ...
  return (
    ...
    >
      ...
      {/* Inner icon */}
      <div className="relative z-10 w-9 h-9 bg-[#3E322A] group-hover:bg-[#556B2F] rounded-full flex items-center justify-center shadow-md transition-all duration-300 group-hover:scale-110">
...
export function StickyOfferRibbon() {
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-[#3E322A] via-[#556B2F] to-[#3E322A] text-white flex items-center justify-center gap-3 py-2.5 px-4 text-xs sm:text-sm font-bold tracking-wide relative overflow-hidden">
        {/* shimmer effect */}
        ...
        <span className="bg-[#C19A6B] text-[#3E322A] text-[9px] font-black px-2 py-0.5 rounded uppercase tracking-widest shrink-0">
          ✦ OFFER
        </span>
        ...
        <Link
          href="/login"
          className="shrink-0 bg-white text-[#3E322A] text-[10px] font-extrabold px-3 py-1 rounded-full hover:bg-[#F4D03F] transition-colors uppercase tracking-wider"
        >
          Claim Now
        </Link>
        <button
